...
--
-- Host: 127.0.0.1    Database: pharmarede
-- ------------------------------------------------------
...
CREATE TABLE `fornecedor` (
  ...
  `cnpj_fornecedor` bigint(20) NOT NULL,
...
INSERT INTO `fornecedor` VALUES (1,'teste','teste',5456454654);
...
-- Dump completed on 2018-10-02 19:55:06
